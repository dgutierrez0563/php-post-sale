...
ALTER TABLE detalleingreso
  ...
  ADD KEY IDIngreso (CodIngreso),
  ADD KEY IDArticulo (CodArticulo),
  ADD KEY created_by (created_by),
  ADD KEY updated_by (updated_by);
...
ALTER TABLE ingreso
	...
	ADD FOREIGN KEY (updated_by) REFERENCES usuario(IDUsuario) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE detalleingreso
	ADD FOREIGN KEY (CodIngreso) REFERENCES ingresomaterias(CodIngreso) ON DELETE RESTRICT ON UPDATE RESTRICT,
	ADD FOREIGN KEY (CodArticulo) REFERENCES articulo(CodArticulo) ON DELETE RESTRICT ON UPDATE RESTRICT,
	ADD FOREIGN KEY (created_by) REFERENCES usuario(CodUsuario) ON DELETE RESTRICT ON UPDATE RESTRICT,
	ADD FOREIGN KEY (updated_by) REFERENCES usuario(CodUsuario) ON DELETE RESTRICT ON UPDATE RESTRICT;
