              ...
              <div class="box-header with-border">
                <div class="form-horizontal">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><strong> Factura Ventas</li></strong>
                  </ol>
              ...
              <div class="panel-body" id="form_registros">
                <div class="panel panel-info">
                  <div class="panel-heading">
                    <strong><i class="fa fa-edit"></i> Nueva Factura</strong>
                  </div>
                    ...
                    <form id="form_create_update" name="form_create_update" method="POST">
                      ...
                      <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="input-group">
                          ...
                          <select class="form-control selectpicker" data-live-search="true" name="idcliente" id="idcliente" required></select>
                        </div>
                      </div>
...
<?php
  ...
  require 'footer.php';
?>
  <script type="text/javascript" src="scripts/ventasdetalles.js"></script>
<?php  
  }
  ob_end_flush();
?>