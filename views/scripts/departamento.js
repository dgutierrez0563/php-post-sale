...
function mostrar(id_departamento){
	$.post("../ajax/departamento.php?action=mostrar",{id_departamento : id_departamento}, function(data,status){
...
function disable(id_departamento){
	bootbox.confirm("<div class='alert alert-warning alert-dismissable'>¿Desea desactivar el departamento?</div>", function(result){
		if (result) {
			$.post("../ajax/departamento.php?action=disable",{id_departamento : id_departamento}, function(e){
				bootbox.alert(e);
				tabla.ajax.reload();
			})
		}
...
function enable(id_departamento){
	bootbox.confirm("<div class='alert alert-warning alert-dismissable'>¿Desea activar el departamento?</div>", function(result){
		if (result) {
			$.post("../ajax/departamento.php?action=enable",{id_departamento : id_departamento}, function(e){
				bootbox.alert(e);
				tabla.ajax.reload();
			})
		}
