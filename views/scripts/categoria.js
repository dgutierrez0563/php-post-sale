...
function mostrar(id_categoria){
	$.post("../ajax/categoria.php?action=mostrar",{id_categoria : id_categoria}, function(data,status){

		data = JSON.parse(data);
		mostrarFormCategoriaRegistro(true); //se visualiza el formulario de regitro para ver os datos
